...
var circular_slider_1 = __webpack_require__(0);
function updateLegendValue(id, value) {
    document.getElementById(id).getElementsByClassName('value')[0].innerHTML = value.toString();
}
function updateLegendColor(id, color) {
    document
        .getElementById(id)
        .getElementsByClassName('legendColor')[0].style.backgroundColor = color;
}
var container = 'slider';
var example1 = new circular_slider_1.CircularSlider({
    color: 'red',
    container: container,
    radius: 190,
    maxValue: 5000,
    minValue: 1000,
    stepValue: 1000,
    onValueChange: function (value) { return updateLegendValue('example1', value); }
});
var example2 = new circular_slider_1.CircularSlider({
    color: 'green',
    container: container,
    radius: 160,
    maxValue: 4000,
...
var example3 = new circular_slider_1.CircularSlider({
    color: 'yellow',
    container: container,
    radius: 130,
    maxValue: 4000,
    minValue: 1000,
    stepValue: 1000,
    onValueChange: function (value) { return updateLegendValue('example3', value); }
});
var example4 = new circular_slider_1.CircularSlider({
    color: 'orange',
    container: container,
    radius: 100,
    maxValue: 4000,
    minValue: 1000,
    stepValue: 1000,
    onValueChange: function (value) { return updateLegendValue('example4', value); }
});
example1.currStep = 0;
example2.currStep = 1;
example3.currStep = 2;
